...
def get_params():
    params = {
        'weight': '/content/drive/MyDrive/yolov5-master/data/best.pt',
        'cfg': '/content/drive/MyDrive/yolov5-master/models/yolov5s_arcade.yaml',
        'device': 'cpu',
...
if __name__ == '__main__':
    ...
    model("/content/drive/MyDrive/yolov5-master/data/images/test.png", '/content/drive/MyDrive/yolov5-master/result')