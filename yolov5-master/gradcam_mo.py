...
class yolov5_heatmap:
    ...
    def __call__(self, img_path, save_path, arcade_bbox_image_path):
        # remove dir if exist
...
#     model("data/images/test.png", 'result')
